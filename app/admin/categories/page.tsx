        ...
        <DialogContent className="bg-white dark:bg-gray-800">
          ...
          <div className="space-y-4">
            <MultiLangInput
              ...
              placeholder={{
                en: t("categories.form.namePlaceholder.en"),
                "zh-TW": t("categories.form.namePlaceholder.zh"),
              }}
            />
            <MultiLangInput
              ...
              placeholder={{
                en: t("categories.form.descriptionPlaceholder.en"),
                "zh-TW": t("categories.form.descriptionPlaceholder.zh"),
              }}
            />
          </div>
          <DialogFooter>
