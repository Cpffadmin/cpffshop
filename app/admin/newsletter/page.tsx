        ...
        <div className="bg-card rounded-lg p-6 shadow-md">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-3">
              <Input
                type="search"
                placeholder={t("newsletter.admin.searchPlaceholder")}
                value={searchTerm}
            ...
            <>
                  ...
                  {filteredSubscribers.map((subscriber) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        <span>{t("newsletter.admin.table.status")}:</span>
                        <Switch
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        {t("newsletter.admin.table.subscribedAt")}:{" "}
                        {new Date(subscriber.subscribedAt).toLocaleDateString()}
                      </div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        {t("newsletter.admin.table.lastEmail")}:{" "}
                      ...
                      <div className="flex justify-end mt-2">
                        ...
                        >
                          {actionLoading === subscriber._id ? (
                            ...
                            t("newsletter.admin.actions.delete")
                          )}
                        </Button>
                      </div>
                    </div>
              ...
              <div className="hidden md:block overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>{t("newsletter.admin.table.email")}</TableHead>
                      <TableHead>
                        {t("newsletter.admin.table.source")}
                      </TableHead>
                      <TableHead>
                        {t("newsletter.admin.table.status")}
                      </TableHead>
                      <TableHead>
                        {t("newsletter.admin.table.subscribedAt")}
                      </TableHead>
                      ...
                      <TableHead>
                        {t("newsletter.admin.table.actions")}
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
