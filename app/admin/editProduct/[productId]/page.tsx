    ...
    const fetchData = async () => {
      try {
        ...
        if (productRes.data) {
          ...
          // Initialize specifications with the category's specification structure
          const initialSpecs =
            category?.specifications?.map((spec: Specification) => {
              // Find existing product specification value if it exists
              const existingSpec = productData.specifications?.find(
                (s: {
                  key: string;
              ...
              // Create a new specification value using the template from category
              return {
          ...
          const updatedProduct = {
            ...
            category:
              ...
              productData.category, // Handle both object and string ID
          };
  ...
  const handleSpecificationChange = (
    ...
    setProduct((prev) => ({
      ...
      specifications: prev.specifications.map((spec) => {
        ...
        // Convert the value to the correct type based on spec.type
