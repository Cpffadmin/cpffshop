  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
        ...
        <div className="bg-card rounded-lg p-6 shadow-md">
          <div className="flex justify-between items-center mb-4">
            ...
            <Button onClick={() => setShowCreateModal(true)}>
              {t("admin.roles.createUserButton")}
            </Button>
          </div>
              ...
              >
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col space-y-2">
                      ...
                      >
                        <SelectTrigger className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                          <SelectValue
                            placeholder={t("admin.roles.selectNewRole")}
                          />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      {user.admin
                        ? t("admin.roles.status.systemAdmin")
                        : t("admin.roles.status.regularAccess")}
                    </span>
                  </div>
                  ...
                  <div className="mt-4 flex justify-end space-x-2">
                    <Button
                      ...
                      disabled={user._id === session?.user?._id}
                    >
                      {t("admin.roles.actions.deleteUser")}
                    </Button>
                  </div>
                </div>
              </div>
      ...
      <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("admin.roles.createUser.title")}</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleCreateUser} className="space-y-4">
            <div>
              <Label htmlFor="name">{t("admin.roles.createUser.name")}</Label>
              <Input
                id="name"
                value={newUser.name}
                onChange={(e) =>
            ...
            <div>
              <Label htmlFor="email">{t("admin.roles.createUser.email")}</Label>
              <Input
                id="email"
                type="email"
                value={newUser.email}
            ...
            <div>
              <Label htmlFor="password">
                {t("admin.roles.createUser.password")}
              </Label>
              <Input
                id="password"
                type="password"
            ...
            <div>
              <Label htmlFor="role">{t("admin.roles.createUser.role")}</Label>
              <Select
                value={newUser.role}
                onValueChange={(value) =>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="admin">
                {t("admin.roles.createUser.makeAdmin")}
              </Label>
            </div>
            <div className="flex justify-end space-x-2">
              ...
              >
                {t("admin.roles.createUser.cancel")}
              </Button>
              <Button type="submit">
                {t("admin.roles.createUser.create")}
              </Button>
            </div>
          </form>
        </DialogContent>
